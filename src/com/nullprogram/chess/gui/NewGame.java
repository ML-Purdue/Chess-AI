...
public class NewGame extends JDialog implements ActionListener {
	...
	public NewGame(final ChessFrame owner) {
		...
		whitePanel = new PlayerSelector("White:", false, 6);
		blackPanel = new PlayerSelector("Black:", false, 5);
	 ...
	 *
	 * @param game
	 *            the game the player will be playing
	 * @param name
	 *            name of type of player
	...
	private Player createPlayer(final Game game, final String name) {
		...
		if ("human".equals(name)) {
			...
			return new com.nullprogram.chess.purdue_unstable_ai.AlphaBetaPruningAI(new Evaluation(0.5,
					2, 1, 0.1, 0.25, -0.5, 0.05, 3, 1000, 3, 1, 9, 5, 1));
		} else {
